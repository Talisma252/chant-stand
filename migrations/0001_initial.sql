...
INSERT INTO liturgy_blocks (service_type, sort_order, role, text_en, text_ro, anchor, is_divider, div_label) VALUES
    ...
    ('lit', 1570, 'choir', 'Amen. Praised be the name of the Lord, henceforth and forevermore. (three times)', 'Amin. Fie numele Domnului binecuvântat, de acum și până în veac. (de trei ori)', NULL, 0, NULL),
